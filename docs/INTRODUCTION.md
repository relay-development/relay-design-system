...
ボタン・入力欄・カード・アラートなど **16 種類のコンポーネント** と、色・余白・文字サイズなどの **デザイントークン** が入っています。
...
- **最新バージョン**: `v0.1.0`
- **入っているもの**: Button / Icon Button / Label Control / Input / Search Input / Selector / Textarea / Checkbox / Radio / Filter Chip / Tab / Simple Table / Card / Badge / Alert / ガイドライン
- **ライセンス**: MIT
