...
ボタン・入力欄・カード・アラートなど **31 種類のコンポーネント** と、色・余白・文字サイズなどの **デザイントークン** が入っています。
...
- **入っているもの**: Button / Icon Button / Button Group / Toggle Button Group / Label Control / Input / Search Input / Token Input / Selector / Textarea / Checkbox / Radio / Filter Chip / Tab / Table / Simple Table / Card / Badge / Alert / Inline Message / Link / Breadcrumb / Side Nav / Pagination / Stepper / Modal / Tooltip / Toggle Switch
- **ライセンス**: MIT
