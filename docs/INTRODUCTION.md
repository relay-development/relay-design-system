...
ボタン・入力欄・カード・アラートなど **32 種類のコンポーネント** と、色・余白・文字サイズなどの **デザイントークン** が入っています。
...
- **入っているもの**: Button / Icon Button / Button Group / Toggle Button Group / Label Control / Input / Search Input / Token Input / Selector / Multi Selector / Textarea / Checkbox / Radio / Filter Chip / Tab / Table / Simple Table / Card / Badge / Alert / Inline Message / Link / Breadcrumb / Side Nav / Pagination / Stepper / Modal / Tooltip / Toggle Switch
- **ライセンス**: MIT
...
9 つのツールが AI から使えるようになります。詳細は GitHub の [README](https://github.com/relay-development/relay-design-system#readme) を参照。
