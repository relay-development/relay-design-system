...
ボタン・入力欄・カード・アラートなど **28 種類のコンポーネント** と、色・余白・文字サイズなどの **デザイントークン** が入っています。
...
- **入っているもの**: Button / Icon Button / Label Control / Input / Search Input / Selector / Textarea / Checkbox / Radio / Filter Chip / Tab / Table / Simple Table / Card / Badge / Alert / Inline Message / Link / Breadcrumb / Side Nav / Pagination / Stepper / Modal / Tooltip / Toggle Switch
- **ライセンス**: MIT
