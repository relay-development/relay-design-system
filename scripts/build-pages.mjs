...
const PAGES = [
  ...
  { file: "icons.html",      group: "Foundations", label: "アイコン",          title: "アイコン",        desc: "Lucide スプライト 58 アイコン" },
  ...
  { file: "toggle-button-group.html", group: "Components", label: "トグルボタングループ", title: "トグルボタングループ", desc: "選択状態を持つボタンの並び（単一 / 複数選択）" },
  ...
  { file: "menu.html",         group: "Components", label: "メニュー",         title: "メニュー",         desc: "縦型のナビ / 常設の操作メニュー" },
  { file: "action-menu.html",  group: "Components", label: "アクションメニュー", title: "アクションメニュー", desc: "ボタンから開く操作のポップアップ" },
